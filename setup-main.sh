...
clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                  KONTOL VPN TUNNELING\033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
...
# --- Definisi Variabel ---
REPO="https://https://raw.githubusercontent.com/xyzval/VVIP/main/"
start=$(date +%s)
secs_to_human() {
...
EOF
    ...
    for i in {1..3}; do
        # Perbaiki URL dengan menambahkan https://
        wget -q -O /etc/systemd/system/udp-mini-${i}.service "https://raw.githubusercontent.com/xyzval/VVIP/main/udp-mini-${i}.service"
    done
...
CHATID="516265441"
TOKEN_BOT="7117869623:AAHBmgzOUsmHBjcTFir9JmaZ_X7ynMoF4"
TIMES=30
